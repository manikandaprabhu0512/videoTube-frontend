...
function Header() {
  ...
  return (
    <nav className="flex items-center justify-center h-20 md:px-10 lg:px-15 xl:px-20 bg-white dark:bg-[#0f0f0f] relative transition-all">
      <div className="flex w-full">
        <div className="flex items-center mr-5">
          <button>
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="size-10 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white rounded-md active:bg-slate-200 dark:active:bg-slate-500 p-2 hover:bg-gray-100 dark:hover:bg-gray-700"
        ...
        <div className="flex justify-between w-full ">
          <div className="hidden w-1/2 lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
            <input
          ...
          <div className="flex gap-3">
            <Link
              to="/upload/video"
              type="button"
              className="w-30 h-10 active:scale-95 transition text-sm text-white rounded-full bg-gray-500 flex items-center justify-center gap-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
