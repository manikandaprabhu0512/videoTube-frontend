    ...
    <>
      {visible ? (
        <aside
          ...
          aria-label="Sidebar"
        >
          <div className="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-[#0f0f0f]">
            <ul className="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <span className="ms-3">Copyright</span>
                </a>
              </li>
              <li>
                <Link
        ...
        <div className="top-0 left-0 z-40 w-12 ml-3 h-screen">
          <ul className="space-y-2 font-medium">
            <li>
              <a
                href="#"
            ...
            <li>
              ...
              >
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  className="w-8 h-8 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white p-1"
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
